    ...
    options: [
      {
        ...
        icon: React.createElement(Castle),
...
export const EVENT_TYPES: FilterCategory = {
  ...
  options: [
    ...
    {
      id: 'kids-events',
      name: 'Детские события',
      icon: React.createElement(Baby, { size: 16 }),
      category: 'events',
    },
    {
      id: 'charity',
      name: 'Благотворительные акции',
